...
## This repository belongs to team 49

- Harvey Randall (hxr286@student.bham.ac.uk)
- Edward Parting (exp211@student.bham.ac.uk)
- Harry Wells (hxw285@student.bham.ac.uk)
- Taran Bains (txb174@student.bham.ac.uk)
- Rufael Amanuel (rxa263@student.bham.ac.uk)
- Thomas Burke (txb206@student.bham.ac.uk)
- Bader Atshan (bxa156@student.bham.ac.uk)
...
- The command `npm run harveys-mac-is-werid` is something I have added cause my mac is refusing to change java version so this command forces the change, please do not remove this from `./package.json`!!
